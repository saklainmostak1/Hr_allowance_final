...
const TransportAllowanceList = ({searchParams}) => {
    ...
    const { data: transportAllowanceAll = [], isLoading, refetch
        ...
        queryFn: async () => {
            const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/Admin/transport_allowance/transport_allowance_all`)
    ...
    const caregory_list = async () => {
        const url = `${process.env.NEXT_PUBLIC_API_URL}/Admin/transport_allowance/transport_allowance_list/${currentPage}/${dataPerPage}`;
    ...
    const transport_allowance_delete = id => {
        ...
        if (proceed) {
            fetch(`${process.env.NEXT_PUBLIC_API_URL}/Admin/transport_allowance/transport_allowance_delete/${id}`, {
                method: "POST",
