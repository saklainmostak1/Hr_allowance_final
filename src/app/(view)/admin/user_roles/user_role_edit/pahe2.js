...
//     useEffect(() => {
//         fetch(`https://hr-allowance-new-server.vercel.app/user/user-role-single/${id}`)
...
//         fetch(`https://hr-allowance-new-server.vercel.app/user/user-role/edit/${userRoleId}`, {
//             method: 'PUT',
//             headers: {
...
//     useEffect(() => {
//         fetch('https://hr-allowance-new-server.vercel.app/user-role/btn')
//             .then(Response => Response.json())
