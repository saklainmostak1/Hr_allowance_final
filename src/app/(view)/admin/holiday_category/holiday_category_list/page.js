...
const HolidayCategoryList = ({searchParams}) => {
    ...
    const caregory_list = async () => {
        const url = `${process.env.NEXT_PUBLIC_API_URL}/Admin/holiday_category/holiday_category_list/${currentPage}/${dataPerPage}`;
    ...
    const holiday_category_delete = id => {
        ...
        if (proceed) {
            fetch(`${process.env.NEXT_PUBLIC_API_URL}/Admin/holiday_category/holiday_category_delete/${id}`, {
                method: "POST",
